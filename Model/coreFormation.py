...
class CultivationCoreFormation:
    def __init__(self):
    ...
    def checkMultiplier(self):
        match self.stage:
            case 1:
                self.currentCultivationexp = self.cultivationexp * 8
            case 2:
                self.currentCultivationexp = self.cultivationexp * 8
            case 3:
                self.currentCultivationexp = self.cultivationexp * 8
    ...
    def breakthroughRealmStage(self):
        requiredExp = {1: 55000, 2: 77000, 3: 101000, 4: 127000, 5: 155000}   
...
if __name__ == '__main__':
    player = CultivationCoreFormation()
    requiredExp = {1: 55000, 2: 77000, 3: 101000, 4: 127000, 5: 155000}   
