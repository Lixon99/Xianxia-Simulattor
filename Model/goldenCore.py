...
class CultivationGoldenCore:
    ...
    def checkMultiplier(self):
        match self.stage:
            case 1:
                self.currentCultivationexp = self.cultivationexp * 12
            case 2:
                self.currentCultivationexp = self.cultivationexp * 12
            case 3:
                self.currentCultivationexp = self.cultivationexp * 12
    ...
    def breakthroughRealmStage(self):
        requiredExp = {1: 200000, 2: 255000, 3: 320000, 4: 395000, 5: 500000}   
